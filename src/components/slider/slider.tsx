...
//   interface SlideToIndexFn {
//     (index: number): void;
//   }

//   const slideToIndex: SlideToIndexFn = (index) => {
...
//         <button
//           id="goback"
//           className="btn btn-secondary rounded-xl border-0 w-[4rem] mr-4"
//           onClick={handlePrev}
...
//         <button
//           id="gocontinue"
//           className="btn btn-secondary border-0 rounded-xl w-[4rem]"
//           onClick={handleNext}
