...
import FinalConfirmation from "../bookingfinalconfirmationscreen/finalconfirmation";
...
const Bookingfinalconfirmationscreen = ({
  step,
  sectiontitle,
  currentslide,
}: SlideProps) => {
...
export default Bookingfinalconfirmationscreen;
